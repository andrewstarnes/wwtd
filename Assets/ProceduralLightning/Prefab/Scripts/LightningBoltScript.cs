...
namespace DigitalRuby.ThunderAndLightning
{
    ...
    public class LightningBolt
    {
        ...
        public void Initialize(bool useWorldSpace, LightningBoltQualitySetting quality, LightningBoltMeshRenderer lightningBoltRenderer, GameObject parent, LightningBoltScript script,
            EZObjectPool originParticleSystem, EZObjectPool destParticleSystem, ICollection<LightningBoltParameters> parameters)
        {
            // setup properties
        ...
        private void ProcessParameters(LightningBoltParameters p, LightningBoltQualitySetting quality,
            EZObjectPool sourceParticleSystem, EZObjectPool destinationParticleSystem, int maxLights)
        {
        ...
        private void RenderLightningBolt(LightningBoltQualitySetting quality, int generations, Vector3 start, Vector3 end, int groupIndex,
            EZObjectPool originParticleSystem, EZObjectPool destParticleSystem, LightningBoltParameters parameters,
        ...
        private IEnumerator GenerateParticle(EZObjectPool p, Vector3 pos, float delay)
        {
            yield return new WaitForSeconds(delay);
			p.TryGetNextObject(pos,Quaternion.identity);
        }
    ...
    public class LightningBoltScript : MonoBehaviour
    {
        ...
        public virtual void CreateLightningBolt(LightningBoltParameters p)
        {
            if (p != null)
            {
                ...
                bolt.Initialize(UseWorldSpace, QualitySetting, lightningBoltRenderer, gameObject, this, LightningOriginParticleSystem,
                    lightningDestinationParticleSystem, oneParameterArray);
                bolts.Add(bolt);
            }
        }
        ...
        public void CreateLightningBolts(ICollection<LightningBoltParameters> parameters)
        {
            if (parameters != null)
            {
                ...
                LightningBolt bolt = LightningBolt.GetOrCreateLightningBolt();
                bolt.Initialize(UseWorldSpace, QualitySetting, lightningBoltRenderer, gameObject, this, LightningOriginParticleSystem,
                    lightningDestinationParticleSystem, parameters);
                bolts.Add(bolt);
            }
        }
    }
